...
The posterior of the regression coefficient `beta_MS[1]` is strongly negative. Since the levels of `pop_type` are ordered `c("natural", "hatchery")`, this indicates that hatchery SAR was lower than natural SAR on average. The respective ESU-level hyper-means of smolt-to-adult survival, summarized by posterior median and 90% credible interval, are `r SARout$mci[2]` for the wild populations and (`r SARout$mci[1]`) for the hatcheries. We show this graphically below.
...
```{r plot_spawners_Ricker, echo = FALSE, warning=FALSE, fig.width=14, fig.height=7, out.width="100%"}
life_stage <- "S"
...
```{r plot_smolts_Ricker, echo = FALSE, warning=FALSE, fig.width=14, fig.height=7, out.width="100%"}
life_stage <- "M"
<<plot_spawner_smolt_ts>>
show(gg)
```
