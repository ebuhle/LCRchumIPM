...
$$
\text{logit}{\left( \psi_j \right)} \sim N 
{\left(\mu_\psi + \mathbf{x}_{\psi jt} \boldsymbol{\beta}_\psi, \sigma_\psi \right)}
$$
...
N{\left( \mu_{M_\text{max}} + \mathbf{x}_{M_\text{max},jt} \boldsymbol{\beta}_{M_\text{max}}, \sigma_{M_\text{max}} \right)}.
$$
...
\\
\eta^\text{year}_{Mt} &\sim N{\left( \rho_{M} \eta^\text{year}_{M,t-1}, 
\sigma^\text{year}_{M} \right)}
\\
\varepsilon_{Mjt} &\sim N{\left( 0, \sigma_{M} \right)}.
\end{aligned}
$$
...
N{\left(\rho_{MS} \eta^\text{year}_{MS,t-1}, \sigma^\text{year}_{MS} \right)}
\\
\varepsilon_{MSjt} &\sim N{\left( 0, \sigma_{MS} \right)}.
\end{aligned}
$$
...
N{\left( \mathbf{0}, \boldsymbol{\Sigma}^\text{pop}_\mathbf{p} \right)}
\\
\boldsymbol{\varepsilon}_{\mathbf{p}jt} &\sim
N{\left( \mathbf{0}, \boldsymbol{\Sigma}_\mathbf{p} \right)}.
\end{aligned}
$$
...
N{\left( 0, \sigma^\text{pop}_\text{F} \right)} 
\\
\varepsilon_{\text{F}jt} &\sim N{\left( 0, \sigma_\text{F} \right)}.
\end{aligned}
$$
...
$$
E_{ai}^\text{obs} \sim N_+ {\left( \mu_{Ea}, \sigma_{Ea} \right)}.
$$
...
N{\left( \mu_{\tilde{M}jt}, \tau_{\tilde{M}jt} \right)}
\\
\text{log}{\left(S_{jt} \right)} &\sim 
N{\left(\mu_{Sjt}, \tau_{Sjt} \right)}.
\end{aligned}
$$
...
N{\left( \mu_{\tau_M},  \sigma_{\tau_M} \right)}
\\
\text{log}{\left( \tau_{Sij} \right)} &\sim 
N{\left( \mu_{\tau_S}, \sigma_{\tau_S} \right)}.
\end{aligned}
$$
